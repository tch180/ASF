        ...
        return (
            <div>
                ...
                <div className="parallax2" style={{ backgroundColor:"black",height:"600px" }}> 
                    ...
                    <h1 className="clan-q" >
                        When the  Red War began <span>they came to us.</span> <br/> When the Dreaming City fell under a curse <span>we were granted access to cleanse their city.</span> <br/> 
                        They put all of their faith and trust into us, but where would they be without us? Imagine not having your light anymore. <span>A war is coming. </span> 
